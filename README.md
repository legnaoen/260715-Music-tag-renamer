...
- 설치 파일: `dist/Music Tag Renamer-0.1.0-arm64.dmg` (Apple Silicon 맥 기준, Intel 맥에서 빌드하면 파일명에 arm64가 붙지 않음)
...
- Installer: `dist/Music Tag Renamer-0.1.0-arm64.dmg` (on Apple Silicon; no `arm64` suffix when built on an Intel Mac)
